# This script was:
# 1. originally created here: https://colab.research.google.com/github/alembics/disco-diffusion/blob/main/Disco_Diffusion.ipynb
# 2. converted into a .py script for Visions of Code
# 3. personalised by rossmurr4y
# 4. intended to be installed as a symlink
...
def save_settings():
    ...
    with open(f"{batchFolder}/{batch_name}({batchNum})_settings.txt", "w+") as f:   #save settings
        json.dump(setting_list, f, ensure_ascii=False, indent=2)
...
diff_model_map = {
    ...
    #deep spce
    'deep_space_256': { 'downloaded': False, 'sha': '7c0d742d714ee512edda3299b440f22c72e95fda3f32e24c4ba1f03e0c4b0524', 'uri_list': ['b0d254fe895d8b67beda3199bb5f3fbe'] },
    #Nintendo
    'DifnesFusion2_160k': { 'downloaded': False, 'sha': '5579385bae4c1708449145a64943546bbb936744e2ef63866444e934bf4c0c5b', 'uri_list': ['https://huggingface.co/datasets/LufiQ/DifNesFusion2_160k/resolve/main/DifnesFusion2_160k.pt'] },
    'DifNESFusion_200k_NES': { 'downloaded': False, 'sha': '911e3e79fe3a2cfffaa335df540b758b71b3da0a302f7c03ba35424b12a8535b', 'uri_list': ['https://huggingface.co/datasets/LufiQ/DifNESFusion_200k_NES/resolve/main/DifNESFusion_200k_NES.pt'] },
    'DifNESFusion_350k_NES': { 'downloaded': False, 'sha': '815e72999b468764d8dd030cd72942c2af2774591c14e753d6f4636729d57cb5', 'uri_list': ['https://huggingface.co/datasets/LufiQ/DifNESFusion_350k_NES/resolve/main/DifNESFusion_350k_NES.pt'] },
    #Fantasy
    'fantasy26': { 'downloaded': False, 'sha': '83c11e4d85e6908450a6d479fbd72e1bbd8b55934f7dc810f970d82a79e48fe5', 'uri_list': ['https://huggingface.co/LaVista/fantasydiffusion/resolve/main/fantasy26.pt'] },
    #Liminal Spaces
    ...
    #hand painted
    'FeiArt-Handpainted-CG-Diffusion': { 'downloaded': False, 'sha': '85f95f0618f288476ffcec9f48160542ba626f655b3df963543388dcd059f86a', 'uri_list': ['https://huggingface.co/Feiart/FeiArt-Handpainted-CG-Diffusion/resolve/main/FeiArt-Handpainted-CG-Diffusion.pt'] },
    #medieval art
    ...
    #architecture
    'architect_410k': { 'downloaded': False, 'sha': '12147fe00a15fee7ff19e0a2082fab9fc219b8f6b743cd38bd8d2e58b526c7ad', 'uri_list': ['https://huggingface.co/datasets/LufiQ/architect_410k/resolve/main/architect_410k.pt'] },
    #retro movie posters
    'movieposter_350k': { 'downloaded': False, 'sha': 'e87cb50bfac14259f3a255cd4cd56fa8352f5e929d6a6c0ccc5269e51454ec68', 'uri_list': ['https://huggingface.co/datasets/LufiQ/RetroMoviePoster/resolve/main/movieposter_350k.pt'] },
    #great magazine art
    'GMADiffusion_550k': { 'downloaded': False, 'sha': 'e26495d2cad9c2f570ac9df3e6fc743d9e7d61a08a50c719445040f9b3892170', 'uri_list': ['https://huggingface.co/datasets/LufiQ/GreatMagazineArt550k/resolve/main/GMADiffusion_550k.pt'] },
    #floral
    'floraldiffusion': { 'downloaded': False, 'sha': '197e9068f1ca0248fd89f9d6ca1f6f851783e04fddd0cc5b0020bfa655ed3aeb', 'uri_list': ['https://www.dropbox.com/s/i0xrhq28ls1e94g/floraldiffusion.pt?dl=1'] },
    #portraits
    'portrait_generator_v001_ema_0.9999_1MM': { 'downloaded': False, 'sha': 'b7e8c747af880d4480b6707006f1ace000b058dd0eac5bb13558ba3752d9b5b9', 'uri_list': ['https://huggingface.co/felipe3dartist/portrait_generator_v001/resolve/main/portrait_generator_v001_ema_0.9999_1MM.pt'] },
    #portrait v1.5
    'portrait_generator_v1_5': { 'downloaded': False, 'sha': '3bc39e28fd9690dafbbee83cc08d089a3640eca8ed4d14280c4a9d342c56fd7f', 'uri_list': ['https://huggingface.co/felipe3dartist/portrait_generator_v1.5/resolve/main/ema_0.9999_165000.pt'] },
    #ukiyo-e portraits
    'ukiyoe_portrait_diffusion_256x256': { 'downloaded': False, 'sha': 'ef93f5f84c7eca3422f6b0887ac12af7a218dca4c3e4c9043a9c5b7122b6aacd', 'uri_list': ['https://huggingface.co/avantcontra/ukiyoe-portrait-diffusion/resolve/main/ukiyoe_portrait_diffusion_256x256.pt'] },
    #textile
...
#elif diffusion_model == 'portrait_generator_v001_ema_0.9999_1MM':
#    model.load_state_dict(torch.load(f'{model_path}/{get_model_filename(diffusion_model)}', map_location='cpu'),strict=False)
#elif diffusion_model == 'ema_0.9999_165000':
#    model.load_state_dict(torch.load(f'{model_path}/{get_model_filename(diffusion_model)}', map_location='cpu'),strict=False)
else:
